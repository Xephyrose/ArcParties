...
//        }
    ...
    private void handleJoin(Player joiner, String[] args) {
        ...
        PartyJoinedEvent event2 = new PartyJoinedEvent(joiner, party);
    ...
    private void handleKick(Player kicker, String[] args) {
        ...
        PartyKickedEvent event2 = new PartyKickedEvent(kicker, target, party);
        Bukkit.getPluginManager().callEvent(event2);
    }
    ...
    private void handleLeave(Player player) {
        ...
        PartyLeftEvent event2 = new PartyLeftEvent(player, party);
        Bukkit.getPluginManager().callEvent(event2);
    }
    ...
    private void handleTransfer(Player transferer, String[] args) {
        ...
        PartyTransferredEvent event2 = new PartyTransferredEvent(transferer, target, party);
        Bukkit.getPluginManager().callEvent(event2);
    }
    ...
    private void handleDisband(Player player, String[] args) {
        ...
        Bukkit.getPluginManager().callEvent(event);
        if (event.isCancelled()) {return;}
        PartyDisbandedEvent event2 = new PartyDisbandedEvent(party.getMembers());
